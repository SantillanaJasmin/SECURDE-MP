            ...
            <form>
                ...
                <div class="row">
                    <div class="five columns">
                        ...
                        <input class="u-full-width" type="text" placeholder="First Name" id="firstName" value="Jasmin">
                    </div>
                    ...
                    <div class="five columns">
                        ...
                        <input class="u-full-width" type="text" placeholder="Last Name" id="lastName" value="Santillana">
                    </div>
                </div>
                <div class="row">
                    <div class="six columns">
                        <label for="email">Email Address</label>
                        <input class="u-full-width" type="email" placeholder="Email Address" id="email" value="jasmin.santillana@gmail.com">
                    </div>
                </div>
                <div class="row">
                    <div class="six columns">
                        <label for="username">Username</label>
                        <input class="u-full-width" type="text" placeholder="Username" id="username" value="jasminsantillana">
                    </div>
                </div>
                <div class="row">
                    <div class="six columns">
                        <label for="temporaryPassword1">Temporary Password</label>
                        <input class="u-full-width" type="password" placeholder="Password" id="password1">
                    </div>
                    <div class="six columns">
                        <label for="temporaryPassword2">Confirm Temporary Password</label>
                        <input class="u-full-width" type="password" placeholder="Confirm Password" id="password2">
                    </div>
                </div>
                <div class="row">
                    <div class="five columns">
                ...
                <button type="reset" style="float:left" id="createAccountButton">Save Changes</button>
            </form>
