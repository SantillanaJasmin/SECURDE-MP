 ...
 * @author Joy
 */
@WebServlet(name = "ViewSalesServlet", urlPatterns = {"/ViewSalesServlet"})
public class ViewSalesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewSalesServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewSalesServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    //        processRequest(request, response);
        ...
        try {
            ...
            Logger.getLogger(ViewSalesServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
        if(sales.size() > 0) {
